...
<img src="./figures/quarto_logo.jpg" height="100%" />
...
- Under the Branches section of Build and deployment:
    - Where it says None, select "main" to deploy the website from the main branch.
    - Toggle the "/(root)" option to "/docs".

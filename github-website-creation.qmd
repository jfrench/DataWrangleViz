...
<a href="https://colab.research.google.com/github/jfrench/DataWrangleViz/blob/master/github-website-creation.ipynb">
   <img src="https://raw.githubusercontent.com/jfrench/DataWrangleViz/b787658003c3cefaf50e6fcba49bc6585942d5ca/qr_codes/qr-github-website-creation.svg">
</a>
---
...
<img src="./figures/new_project_wizard_quarto_website.png" width="100%" />
...
6. Regarding the check boxes, I'd recommend:
    - Checking the box next to "Create a git repository" so that we can easily push this project to GitHub later.
        - If you don't check this box now, you can initialize git later by running `git init` in the Terminal window.
        - If you don't have this option, then you probably don't have git installed.
        - Follow the instructions at [https://colab.research.google.com/github/jfrench/DataWrangleViz/blob/master/version-control-with-rstudio-and-github.ipynb](https://colab.research.google.com/github/jfrench/DataWrangleViz/blob/master/version-control-with-rstudio-and-github.ipynb) to install git and link RStudio with GitHub for version control.
    - Uncheck the boxes next to "Use renv with this project".
        - **renv** is a package for project-local R dependency management.
        - Unless you're running completed R code on your webpages, then this isn't needed
    - Uncheck "Use visual markdown editor".
        - The visual markdown editor provides standard word processor like interface to your project.
        - For me, this causes more problems than it solves, so I don't use this.
        - You may have a different preference.
7. Click "Create Project".

The recommended choices are shown below.

- Make sure to change `username` to your *actual* username.
- In the associated video, we will set the Directory name to `demosite`.

<img src="./figures/create_quarto_website.png" width="100%" />
...
<img src="./figures/created_quarto_website_project.png" width="100%" />
...
## Publishing a Quarto website on GitHub Pages (Video: [YouTube](https://youtu.be/uimdXPZc40I), [Panopto](https://ucdenver.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=7e0f5d3e-cbfd-44c6-b8a1-b2490006a5fd))
...
- From the main page, create a GitHub repository.
    - For your personal website, the repository name should be `username.github.io`.
...
<img src="./figures/create_username_github_io_respository.png" width="100%" />

We need to push our Quarto website from our local repository to GitHub.

- Push the changes to the repository your want to be hosted by GitHub pages.
- If you're not familiar with doing this using Git, then you can literally copy the contents of your project directory to GitHub. 

Assuming git has been installed and linked with RStudio, we can push the contents of our current project to the appropriate GitHub repository by running the following commands in the Terminal window:
...
Once we have pushed our local repository to GitHub, we need to setup GitHub Pages for the repository.
...
- If you've set the output directory for your website to "docs" (which you should), then toggle the "/(root)" option to "/docs" and click the "Save" button. 

This is demonstrated in the graphic below.

<img src="./figures/github_pages.png" width="100%" />
...
The graphic below displays the New Quarto Document window you would have to create a new Quarto document with the title "Favorites". 

<img src="./figures/new_quarto_document_favorites.png" width="100%" />

The graphic below shows the Save File window you would use to create `favorites.qmd`.

<img src="./figures/save_quarto_dialog.png" width="100%" />

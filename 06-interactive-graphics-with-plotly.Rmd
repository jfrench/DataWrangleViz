...
# Easily create interactive graphics in R (bar plot)
...
We create interactive scatter plots using two approaches.

In the code below, we:

1. Use **ggplot2** to create a scatter plot of `bill_length_mm` versus `body_mass_g` that uses different colors and shapes to distinguish the different `species`. We assign this plot the name `ggscatter`.
1. Use `plotly::ggplotly` to make the graphic interactive.
...
# Interactive scatter plots with smooths

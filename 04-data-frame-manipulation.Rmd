...
This document is intended to help you quickly learn how to perform basic data visualization using **dplyr** [@R-dplyr] and **tidyr** [@R-tidyr].
...
# Data frame manipulation with **dplyr** and **tidyr** ([Manipulation packages video](https://youtu.be/O5_Lj5FSX6E))
...
## Tibbles ([tibble video](https://youtu.be/BlnebGyuOKM))
...
### Differences between a tibble and a `data.frame` ([tibble versus `data.frame` video](https://youtu.be/_qHdqWx-vsQ))
...
penguins
```
### Subsetting/extracting parts of a tibble ([subsetting a tibble video](https://youtu.be/xR3x9Mbd_6A))
...
### Important functions for tibbles ([tibble-related functions video](https://youtu.be/2zddbMKnxrY))
...
tbl1
```
## Using **dplyr** ([dplyr overview video](https://youtu.be/kB-YSQ4r2Yc))
...
### Filtering ([dplyr filtering video](https://youtu.be/8tazJbgcDWg))
...
### Slicing ([dplry slice video](https://youtu.be/4_YptM2twH0))
...
### Grouping and summarizing ([dplyr grouping and summarizing video](https://youtu.be/LaA7sVe76PA))
...
penguins %>%
  ...
  summarize(mean_bill_length_mm = mean(bill_length_mm, na.rm = TRUE),
            ...
            count = n())
```
### Selecting ([dplyr select video](https://youtu.be/Su1VcLnIBuM))
...
### Column renaming ([dplyr rename video](https://youtu.be/5xuACH1a5UI))
...
```
### Mutating a column ([dplyr mutate video](https://youtu.be/uiEzbFf5zJw))
...
### Relocating a column ([dplyr relocate video](https://youtu.be/efEvcF3VLMY))
...
```
## Tidy data ([tidy data overview](https://youtu.be/uvDKLIK8i7E))
...
## Using **tidyr** ([tidy data tips video](https://youtu.be/j5iH9ciMkL8))
...
### Widening data frames ([tidyr pivot_wider video](https://youtu.be/7cNxHl5aj-c))
...
```
### Lengthening data frames ([tidyr pivot_longer video](https://youtu.be/nhwcyk7bpQc))
...
### Merging/joining data frames ([merging data frames video](https://youtu.be/-M4VIuemN08))
...
```
## Separating and uniting columns ([tidyr separate and unite video](https://youtu.be/GQMF2qNuZHI))

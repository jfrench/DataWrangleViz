...
Tidying complicated data sets may require you to do seemingly odd steps like making a data frame longer and then widening some of the lengthened columns.
...
```
### Lengthening data frames

The `pivot_taller` function decreases the number of columns in a data frame but increases the number of rows. The main arguments of the `pivot_wider` function are:
...
* `into`: the variables to which the column will be separated

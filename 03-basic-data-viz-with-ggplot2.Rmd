...
by following the link [here](https://youtube.com/playlist?list=PLkrJrLs7xfbVbI1WHs8FfkOoFvtiI6EXd). I have also included direct, relevant video links throughout the file (e.g., immediately after the the relevant heading). An html version of this document can be downloaded to your current working direction (run `getwd()` in the Console to see where this is) by running the following command:
```{r, eval=FALSE}
...
knitr::write_bib(c(
  .packages(), 'ggplot2', 'patchwork', 'penguins', 'palmerpenguins',
  'HistData'
), 'packages_basic_data_viz.bib')
```

# Basic data visualization with **ggplot2** ([Introduction video](https://youtu.be/9F-4q-sI3sI))
...
## Graphics ecosystems in R ([Graphics ecosystems video](https://youtu.be/R12YAjSze0I))
...
## Basic ingredients ([Basic ingredients video](https://youtu.be/k6a3vMoBXSw))
...
### The `penguins` data ([Introducing the penguins data video](https://youtu.be/XpsV65um6Uc))
...
### Bar chart ([Bar charts video](https://youtu.be/cBwC1SKz_gA))
...
### Histogram ([Histogram video](https://youtu.be/gFZpBO38HUg))
...
### Density plot ([Density plots and scaling video](https://youtu.be/UGeJ73k6BGs))
...
### Boxplots ([Boxplots video](https://youtu.be/EZjkg_hsh-w))
...
### Violin plots ([Violin plots video](https://youtu.be/QbVWcjxYgHY))
...
### Scatter plots ([Scatter plots and scaling video](https://youtu.be/DjORoUDMLD4))
...
### Adding smooths ([Adding smooths video](https://youtu.be/P2_qYBV1Byc))
...
```
### Using common aesthetics across geometries ([Common geometries video](https://youtu.be/oFWHATa7AQw))
...
## Customizing plots ([Customizing a ggplot video](https://youtu.be/Pe5r881J4p8))
...
### Facetting ([Facetting a ggplot video](https://youtu.be/6NGrEJ7phTA))
...
### Statistical transformations ([`stat` argument video](https://youtu.be/ia7CZEBgoKc))
...
#### Jittering data ([Jittering data video](https://youtu.be/Rv3oNQQIKIw))
...
#### Stacking, filling, and dodging ([Stacking, filling, and dodging video](https://youtu.be/q1tTRuReq7w))
...
### Coordinate Systems ([Flipping coordinates video](https://youtu.be/naQPwZxkb2M))

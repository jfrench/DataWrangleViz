...
### Commenting code (Video: [YouTube](https://youtu.be/K-CCEx2tbHI),  [Panopto](https://ucdenver.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=daf64b81-e313-4f45-9d05-af030171b257))
...
One of the incredible features of R Markdown is that you can easily produce multiple output types from a single document. Simply include multiple output types in your YAML header and then choose the desired output with a click of the down arrow next to the `r knitr::include_graphics("./figures/knit_button.png")` button. Some of the main document output types are:
...
## Cross-references (Video: [Cross-references video](https://youtu.be/tVNBegYx2Oc),  [Panopto](https://ucdenver.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=cf0621e0-79d0-420c-b38e-af0801711b7e))

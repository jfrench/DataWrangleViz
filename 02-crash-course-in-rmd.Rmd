...
You need to add something like: `bibliography: filename.filetype` to the header.

 * Many biblgiography types are supported. A list of supported file types is currently available at [https://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html](https://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html)
 
Citations must be placed in square brackets.

* Multiple citation should be separated by semicolons. 
...
* Presentation: Use the `ioslides_presentation` or the `slidy_presentation` output type (there are others) to create a presentation.

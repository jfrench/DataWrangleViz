...
knitr::write_bib(c("dplyr", "tibble", "tidyr", "palmerpenguins", "magrittr", "data.table", "reshape", "reshape2", "dbplyr", "dtplyr", "sf", "sp", "colorspace", "remotes", "viridis"), file = "packages_manip.bib")
set.seed(10403)
```

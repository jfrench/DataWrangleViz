...
knitr::write_bib(c("dplyr", "tibble", "tidyr", "palmerpenguins", "magrittr", "data.table", "reshape", "reshape2", "dbplyr", "dtplyr", "sf", "sp", "colorspace", "remote", "viridis"), file = "packages_manip.bib")
set.seed(10403)
```
...
* We install the package from GitHub using the `remote::install_github` function.
  * Make sure to install the **remote** package [@R-remote] if you don't have it.
* We then load the `covid_20210307` data set from the **bayesutils** package.

```{r}
# install.packages("remote")
# remote::install_github("jfrench/bayesutils")

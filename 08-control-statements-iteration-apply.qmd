...
Iteration is when our program repeatedly running a block of code until a terminating condition is satisfied. 

- We "iteratively" run the code block until some condition is satisfied.
